...
const handleNavHover = function (e, opacity) {
  ...
  const otherLinks = clickedLink.closest('.nav').querySelectorAll('.nav__link')
...
const sectionOnePosition = section1.getBoundingClientRect()

window.addEventListener('scroll', function (e) {
  if (window.scrollY > sectionOnePosition.top) {
